...
namespace HospitalInfrastracture.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(DbhospitalContext context)
        {
            _context = context;
        }
        ...
        {
            var dbhospitalContext = _context.Appointments.Include(a => a.Doctor).Include(a => a.Hospital).Include(a => a.Patient);
        ...
        public async Task<IActionResult> Create([Bind("Id,PatientId,DoctorId,HospitalId,Cabinet,Date")] Appointment appointment)
        {
            ...
            ViewData["HospitalId"] = new SelectList(_context.Hospitals, "Id", "Id", appointment.HospitalId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PatientId,DoctorId,HospitalId,Cabinet,Date")] Appointment appointment)
        {
